...
# PopCustoms withdrew their express option in 2026. Flip this on only if they
# bring it back, otherwise the express quote below is sold but unfulfillable.
ENABLE_POPCUSTOMS_EXPRESS = env_bool('ENABLE_POPCUSTOMS_EXPRESS', False)
